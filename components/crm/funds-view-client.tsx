                  ...
                  <>
                    ...
                    <div className="px-4 py-3 border-b border-slate-100">
                      ...
                      {editingFundField === "desc" ? (
                        ...
                        >
                          {selected.desc || (selectedId && generatingIds.has(selectedId)
                            ? <span className="text-violet-400 italic">Writing description…</span>
                            : <span className="italic">No description — double-click to write one</span>
                          )}
                        </p>
                      )}
                    </div>
